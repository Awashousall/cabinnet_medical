        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    // Vérification si l'adresse e-mail a été saisie
                    if (isset($_POST['email'])) {
                        ...
                        if ($resultat !== false) {
                            if (mysqli_num_rows($resultat) > 0) {
                                ...
                                echo "<tr><td colspan='12'>Aucun dossier médical trouvé.</td></tr>";
                            }
                        } else {
                            echo "<tr><td colspan='12'>Erreur lors de l'exécution de la requête : " . mysqli_error($connexion) . "</td></tr>";
                        }

                        // Fermeture de la connexion
                        mysqli_close($connexion);
                    } else {
                        echo "<tr><td colspan='12'>Aucune adresse e-mail spécifiée.</td></tr>";
                    }
                }
                ?>
            </tbody>
